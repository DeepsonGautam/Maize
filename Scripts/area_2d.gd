...
func _on_body_entered(body):
	if body.is_in_group("player"):
		...
		elif current_scene == "res://Scene/world_5.tscn":
			get_tree().change_scene_to_file("res://Scene/world_7.tscn")
		elif current_scene == "res://Scene/world_7.tscn":
			get_tree().change_scene_to_file("res://Scene/world_6.tscn")
		elif current_scene == "res://Scene/world_6.tscn":
			get_tree().change_scene_to_file("res://Scene/world_8.tscn")
		elif current_scene == "res://Scene/world_8.tscn":
